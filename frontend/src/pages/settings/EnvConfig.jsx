...
function EnvironmentPanel() {
  ...
  return (
    <div style={{ display: 'flex', gap: 16, minHeight: 500 }}>
      {/* 左侧环境列表 */}
      <div style={{ width: 200, background: 'rgba(255,255,255,0.45)', borderRadius: 10, border: '1px solid rgba(0,0,0,0.04)', display: 'flex', flexDirection: 'column', flexShrink: 0 }}>
      ...
      {/* 右侧环境详情 */}
      <div style={{ flex: 1, background: 'rgba(255,255,255,0.45)', borderRadius: 10, border: '1px solid rgba(0,0,0,0.04)', padding: '20px 24px' }}>
        {selectedEnv ? (<>
...
function GlobalVariablePanel() {
  ...
  return (
    <div style={{ background: 'rgba(255,255,255,0.45)', borderRadius: 10, border: '1px solid rgba(0,0,0,0.04)', padding: '20px 24px', maxWidth: 800 }}>
...
function CommonVarHint() {
  return (
    <div style={{ marginTop: 16, padding: '12px 16px', background: '#f9fafb', borderRadius: 12, border: '1px solid rgba(0,0,0,0.04)' }}>
